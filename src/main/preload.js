...
contextBridge.exposeInMainWorld("api", {
  ...
  inventario: {
    getMovimientos: (filtros) =>
      ipcRenderer.invoke("inventario:getMovimientos", filtros),
    ...
    resumenProducto: (id) =>
      ipcRenderer.invoke("inventario:resumenProducto", id),
  },
  ...
  clientes: {
    ...
    createPrecioEspecial: (data) =>
      ipcRenderer.invoke("clientes:precios:create", data),
    updatePrecioEspecial: (data) =>
      ipcRenderer.invoke("clientes:precios:update", data),
    deletePrecioEspecial: (id) =>
      ipcRenderer.invoke("clientes:precios:delete", id),
  ...
  ordenes: {
    ...
    update: (id, data) => ipcRenderer.invoke("ordenes:update", { id, data }),
    updateEstado: (id, estado) =>
      ipcRenderer.invoke("ordenes:updateEstado", { id, estado }),
    updateEstadoPago: (id, estadoPago) =>
      ipcRenderer.invoke("ordenes:updateEstadoPago", {
        id,
